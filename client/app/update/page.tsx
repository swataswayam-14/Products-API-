...
const page = () => {
    ...
    async function handleSubmit() {
        if(!name ||! price || ! company || !rating || !ID) {
            alert("Please Enter All the fields!");
            return;
        }
        const apiUrl = `http://localhost:9023/api/v1/products/${ID}`
        try{
  ...
  return (
    <div >
        <center>
            ...
            <input onChange={(e)=>handleChange(e,setID)} value={ID} type="text" placeholder='Enter ID of product to be updated'/><br /><br />
            <br />
